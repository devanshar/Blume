...
const Navbar = memo(({ searchText }) => {
  ...
  return (
    <div className='bg-white mt-1 mb-6 flex justify-between items-center h-20 max-w-[1800px] mx-auto px-3 text-black border-2 border-black'>
      {/* Logo */}
